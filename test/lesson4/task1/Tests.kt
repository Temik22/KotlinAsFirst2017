...
class Tests {
    ...
    fun convert() {
        ...
        assertEquals(listOf(0), convert(0, 144))
    }
    ...
    fun russian() {
        ...
        assertEquals("триста семьдесят восемь тысяч триста тридцать", russian(378330))
        assertEquals("сто одиннадцать тысяч сто десять", russian(111110))
    }
}